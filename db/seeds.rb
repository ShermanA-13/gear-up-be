...
item_1 = Item.create!(id: 50, user_id: user_1.id, name: "Water Bottle", description: "thing", category: 1, count: 5)
item_2 = Item.create!(id: 51, user_id: user_1.id, name: "Trail Mix", description: "thing", category: 2, count: 8)
item_3 = Item.create!(id: 52, user_id: user_2.id, name: "Good Socks", description: "thing", category: 3, count: 3)
item_4 = Item.create!(id: 53, user_id: user_2.id, name: "Fancy Tent", description: "thing", category: 4, count: 1)
